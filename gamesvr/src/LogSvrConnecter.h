...
**/
#ifndef _CLD_LOGSVRCONNECTER_7FGFDGH4U87_
#define _CLD_LOGSVRCONNECTER_7FGFDGH4U87_
#pragma once

#include "network/sockettask.h"
#include "server_cmd.h"

class CLogSvrConnecter:public CLoopbufAsyncConnecterTask{
public:
	union {
		struct {
			WORD svr_id;
	...
	//////////////////////////////////////////////////////////////////////////
	CLogSvrConnecter(stServerInfo* psvrinfo):CLoopbufAsyncConnecterTask(),svr_id_type_value(0),m_bovalid(false){
		if (psvrinfo){
