#ifndef _CLD_SUPERGAMESVRCONNETER_4SDJFA0ERS_H_
#define _CLD_SUPERGAMESVRCONNETER_4SDJFA0ERS_H_
#pragma once

#include "network/sockettask.h"
#include "server_cmd.h"

class CSuperGameSvrConnecter:public CLoopbufAsyncConnecterTask{
public:
	union {
		struct {
			WORD svr_id;
	...
	//////////////////////////////////////////////////////////////////////////
	CSuperGameSvrConnecter(stServerInfo* psvrinfo):CLoopbufAsyncConnecterTask(),svr_id_type_value(0),m_bovalid(false){
		if (psvrinfo){
