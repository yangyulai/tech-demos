#ifndef _CLD_GLOBALSVRCONNETER_4SDJFA0ERS_H_
#define _CLD_GLOBALSVRCONNETER_4SDJFA0ERS_H_
#pragma once

#include "network/sockettask.h"
#include "server_cmd.h"

class CGlobalSvrConnecter:public CLoopbufAsyncConnecterTask{
public:
	union {
		struct {
			WORD svr_id;
	...
	//////////////////////////////////////////////////////////////////////////
	CGlobalSvrConnecter(stServerInfo* psvrinfo):CLoopbufAsyncConnecterTask(),svr_id_type_value(0),m_bovalid(false){
		if (psvrinfo){
