#ifndef _CLD_TENCENTAPIGAMESVRCONNETER_4SDJFA0ERS_H_
#define _CLD_TENCENTAPIGAMESVRCONNETER_4SDJFA0ERS_H_
#pragma once

#include "network/sockettask.h"
#include "server_cmd.h"

class CTencentApiGameSvrConnecter:public CLoopbufAsyncConnecterTask{
public:
	union {
		struct {
			WORD svr_id;
	...
	//////////////////////////////////////////////////////////////////////////
	CTencentApiGameSvrConnecter(stServerInfo* psvrinfo):CLoopbufAsyncConnecterTask(),svr_id_type_value(0),m_bovalid(false){
		if (psvrinfo){
...
#endif		//_CLD_SCRIPTGAMESVRCONNETER_4SDJFA0ERS_H_