#ifndef _CLD_SCRIPTGAMESVRCONNETER_4SDJFA0ERS_H_
#define _CLD_SCRIPTGAMESVRCONNETER_4SDJFA0ERS_H_
#pragma once

#include "network/sockettask.h"
#include "server_cmd.h"

class CScriptGameSvrConnecter:public CLoopbufAsyncConnecterTask{
public:
	union {
		struct {
			WORD svr_id;
	...
	//////////////////////////////////////////////////////////////////////////
	CScriptGameSvrConnecter(stServerInfo* psvrinfo):CLoopbufAsyncConnecterTask(),svr_id_type_value(0),m_bovalid(false){
		if (psvrinfo){
